        ...
        <div class="selection:bg-rose-500 selection:text-white">
            <div class="min-h-screen bg-rose-100 flex justify-center items-center">
                ...
                <div class="w-80 bg-white rounded-3xl mx-auto overflow-hidden shadow-xl">
                    ...
                    <form class="mt-12" action="" method="">
                        <div class="relative">
                        ...
                        <button type="sumbit" value="Sign in" class="mt-20 px-4 py-2 rounded bg-rose-500 hover:bg-rose-400 text-white font-semibold text-center block w-full focus:outline-none focus:ring focus:ring-offset-2 focus:ring-rose-500 focus:ring-opacity-80 cursor-pointer" >SIgn in</button>
                    </form>
